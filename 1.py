...
def rename_files(name, digits, source, dest_ex, name_range=(0, -1)):
    ...
    for i, file in enumerate(filtered_files, 1):
        ...
        new_name = f"{old_name}_{name}_{str(i).zfill(digits)}{dest_ex}"
